...
public class VehicleEngineController {
    ...
    @GetMapping
    @Operation(summary = "Get all vehicle engines", description = "Retrieves a list of all vehicle engines.")
    public List<VehicleEngineDto> listAll() {
        return vehicleEngineService.getAllEngines();
    }

    @GetMapping("/{id}")
    @Operation(summary = "Get vehicle engine by ID", description = "Retrieves a vehicle engine by its ID.")
    public VehicleEngineDto getById(@PathVariable String id) {
        return vehicleEngineService.getEngineById(id);
    }

    @PostMapping
    @Operation(summary = "Create a new vehicle engine", description = "Creates a new vehicle engine with the provided details.")
    public VehicleEngineDto create(@RequestBody VehicleEngineDto dto) {
        return vehicleEngineService.saveEngine(dto);
    }

    @PutMapping("/{id}")
    @Operation(summary = "Update a vehicle engine", description = "Updates an existing vehicle engine by ID.")
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "Delete a vehicle engine", description = "Deletes a vehicle engine by its ID.")
